...
NSArray* Gradients(void);

CAGradientLayer* GradientLayer(void);
#pragma mark -  Device Color Helper
UIColor* ColorGetDeviceColor(void);

#pragma mark - Image Helpers
UIImage* ImageGetImageOfColorAndSize(UIColor *color, CGSize size);
UIImage* ImageGetTransparentImage(void);
